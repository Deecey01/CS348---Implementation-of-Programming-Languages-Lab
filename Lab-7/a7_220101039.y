...
function_declarator:
    IDENTIFIER '(' parameter_list ')'         { logging("function_declarator --> IDENTIFIER ( parameter_list ) (Function declarator with parameters)"); }
    | IDENTIFIER '(' ')'                        { logging("function_declarator --> IDENTIFIER ( ) (Function declarator without parameters)"); }
    ;
...
function_definition:
    type_specifier function_declarator compound_statement                    { logging("function_definition --> type_specifier function_declarator compound_statement"); }
    | type_specifier function_declarator declaration_list compound_statement { logging("function_definition --> type_specifier function_declarator declaration_list compound_statement"); }
    ;
